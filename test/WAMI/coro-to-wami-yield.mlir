...
module {
  ...
  func.func private @coro.resume.yielder(%h: i64, %x: i32)
      -> (i64, i1, i32)
  func.func private @coro.yield.yielder(%x: i32) -> i32

  func.func @coro.impl.yielder(%x: i32) -> i32 {
    %y = func.call @coro.yield.yielder(%x) : (i32) -> i32
    return %y : i32
  }
  ...
  func.func @main() -> i32 {
    ...
    %h2, %done, %r = func.call @coro.resume.yielder(%h, %x)
        : (i64, i32) -> (i64, i1, i32)
    return %r : i32
  }
}
