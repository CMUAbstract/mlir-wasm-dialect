module {
  func.func @main() -> i32 {
    ...
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      ...
      memref.store %cst_7, %alloc_9[%arg0] : memref<2000xf64>
      memref.store %cst_7, %alloc_8[%arg0] : memref<2000xf64>
    ...
    affine.for %arg0 = 0 to 2000 {
      ...
      affine.for %arg1 = 0 to 2000 {
        %6 = affine.load %alloc[%arg0, %arg1] : memref<2000x2000xf64>
        ...
        affine.store %16, %alloc[%arg0, %arg1] : memref<2000x2000xf64>
      }
    }
    affine.for %arg0 = 0 to 2000 {
      affine.for %arg1 = 0 to 2000 {
        %0 = affine.load %alloc_9[%arg0] : memref<2000xf64>
        %1 = affine.load %alloc[%arg1, %arg0] : memref<2000x2000xf64>
        ...
        affine.store %9, %alloc_9[%arg0] : memref<2000xf64>
      }
    }
    affine.for %arg0 = 0 to 2000 {
      %0 = affine.load %alloc_9[%arg0] : memref<2000xf64>
      ...
      affine.store %6, %alloc_9[%arg0] : memref<2000xf64>
    }
    affine.for %arg0 = 0 to 2000 {
      affine.for %arg1 = 0 to 2000 {
        %0 = affine.load %alloc_8[%arg0] : memref<2000xf64>
        %1 = affine.load %alloc[%arg0, %arg1] : memref<2000x2000xf64>
        %2 = arith.mulf %1, %cst_0 : f64
        %3 = affine.load %alloc_9[%arg1] : memref<2000xf64>
        %4 = arith.mulf %2, %3 : f64
        %5 = arith.addf %0, %4 : f64
        affine.store %5, %alloc_8[%arg0] : memref<2000xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      %0 = memref.load %alloc_8[%arg0] : memref<2000xf64>
