module {
  func.func @main() -> i32 {
    ...
    affine.for %arg0 = 0 to 2100 {
      affine.store %cst_1, %alloc[%arg0] : memref<2100xf64>
    }
    affine.for %arg0 = 0 to 1900 {
      affine.store %cst_1, %alloc_3[%arg0] : memref<1900xf64>
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 2100 {
        %3 = affine.load %alloc_3[%arg0] : memref<1900xf64>
        %4 = arith.index_cast %arg1 : index to i32
        %5 = arith.addi %0, %4 : i32
        %6 = arith.remsi %5, %c2100_i32 : i32
        ...
        affine.store %13, %alloc_3[%arg0] : memref<1900xf64>
      }
      %1 = arith.index_cast %arg0 : index to i32
      %2 = affine.load %alloc_3[%arg0] : memref<1900xf64>
      affine.for %arg1 = 0 to 2100 {
        %3 = affine.load %alloc[%arg1] : memref<2100xf64>
        %4 = arith.index_cast %arg1 : index to i32
        ...
        affine.store %10, %alloc[%arg1] : memref<2100xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c2100 step %c1 {
      %0 = memref.load %alloc[%arg0] : memref<2100xf64>
