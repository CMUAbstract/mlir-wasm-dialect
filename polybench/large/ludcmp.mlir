...
module {
  func.func @main() -> i32 {
    ...
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      memref.store %cst_0, %alloc_4[%arg0] : memref<2000xf64>
    ...
    %alloc_6 = memref.alloc() : memref<2000x2000xf64>
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      scf.for %arg1 = %c0 to %c2000 step %c1 {
        memref.store %cst_0, %alloc_6[%arg0, %arg1] : memref<2000x2000xf64>
      }
    }
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      scf.for %arg1 = %c0 to %c2000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c2000 step %c1 {
          ...
          %4 = memref.load %alloc_6[%arg1, %arg2] : memref<2000x2000xf64>
          %5 = arith.addf %4, %3 : f64
          memref.store %5, %alloc_6[%arg1, %arg2] : memref<2000x2000xf64>
        }
      }
    }
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      scf.for %arg1 = %c0 to %c2000 step %c1 {
        %1 = memref.load %alloc_6[%arg0, %arg1] : memref<2000x2000xf64>
        memref.store %1, %alloc[%arg0, %arg1] : memref<2000x2000xf64>
      }
    }
    memref.dealloc %alloc_6 : memref<2000x2000xf64>
    call @toggle_gpio() : () -> ()
    %alloca = memref.alloca() : memref<f64>
    affine.for %arg0 = 0 to 2000 {
      affine.for %arg1 = 0 to #map(%arg0) {
        %1 = affine.load %alloc[%arg0, %arg1] : memref<2000x2000xf64>
        ...
        %3 = affine.load %alloc[%arg1, %arg1] : memref<2000x2000xf64>
        %4 = arith.divf %2, %3 : f64
        affine.store %4, %alloc[%arg0, %arg1] : memref<2000x2000xf64>
      }
      affine.for %arg1 = #map(%arg0) to 2000 {
        %1 = affine.load %alloc[%arg0, %arg1] : memref<2000x2000xf64>
        affine.store %1, %alloca[] : memref<f64>
        affine.for %arg2 = 0 to #map(%arg0) {
          %3 = affine.load %alloc[%arg0, %arg2] : memref<2000x2000xf64>
          %4 = affine.load %alloc[%arg2, %arg1] : memref<2000x2000xf64>
        ...
        %2 = affine.load %alloca[] : memref<f64>
        affine.store %2, %alloc[%arg0, %arg1] : memref<2000x2000xf64>
      }
    }
    affine.for %arg0 = 0 to 2000 {
      %1 = arith.index_cast %arg0 : index to i32
      ...
      affine.for %arg1 = 0 to #map(%arg0) {
        ...
        %9 = affine.load %alloc_5[%arg1] : memref<2000xf64>
      ...
      affine.store %7, %alloc_5[%arg0] : memref<2000xf64>
    }
    affine.for %arg0 = 0 to 2000 {
      %1 = affine.load %alloc_5[-%arg0 + 1999] : memref<2000xf64>
      affine.store %1, %alloca[] : memref<f64>
      affine.for %arg1 = #map1(%arg0) to 2000 {
        %5 = affine.load %alloc[-%arg0 + 1999, %arg1] : memref<2000x2000xf64>
        %6 = affine.load %alloc_4[%arg1] : memref<2000xf64>
        %7 = arith.mulf %5, %6 : f64
        %8 = affine.load %alloca[] : memref<f64>
        %9 = arith.subf %8, %7 : f64
        affine.store %9, %alloca[] : memref<f64>
      ...
      %2 = affine.load %alloca[] : memref<f64>
      %3 = affine.load %alloc[-%arg0 + 1999, -%arg0 + 1999] : memref<2000x2000xf64>
      %4 = arith.divf %2, %3 : f64
      affine.store %4, %alloc_4[-%arg0 + 1999] : memref<2000xf64>
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c2000 step %c1 {
