  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    scf.for %arg0 = %c0 to %c1400 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        ...
        memref.store %6, %alloc[%arg0, %arg1] : memref<1400x1200xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 1200 {
      affine.store %cst_1, %alloc_6[%arg0] : memref<1200xf64>
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 1400 {
        ...
        %9 = affine.load %alloc_6[%arg0] : memref<1200xf64>
        %10 = arith.addf %9, %8 : f64
        affine.store %10, %alloc_6[%arg0] : memref<1200xf64>
      }
      %1 = affine.load %alloc_6[%arg0] : memref<1200xf64>
      %2 = arith.divf %1, %cst_3 : f64
      affine.store %2, %alloc_6[%arg0] : memref<1200xf64>
    }
    affine.for %arg0 = 0 to 1200 {
      affine.store %cst_1, %alloc_7[%arg0] : memref<1200xf64>
      %0 = arith.index_cast %arg0 : index to i32
      %1 = affine.load %alloc_6[%arg0] : memref<1200xf64>
      affine.for %arg1 = 0 to 1400 {
        ...
        %15 = affine.load %alloc_7[%arg0] : memref<1200xf64>
        %16 = arith.addf %15, %14 : f64
        affine.store %16, %alloc_7[%arg0] : memref<1200xf64>
      }
      %2 = affine.load %alloc_7[%arg0] : memref<1200xf64>
      %3 = arith.divf %2, %cst_3 : f64
      %4 = math.sqrt %3 : f64
      %5 = arith.cmpf ole, %4, %cst_2 : f64
      %6 = arith.select %5, %cst_0, %4 : f64
      affine.store %6, %alloc_7[%arg0] : memref<1200xf64>
    }
    affine.for %arg0 = 0 to 1400 {
      affine.for %arg1 = 0 to 1200 {
        %0 = affine.load %alloc_6[%arg1] : memref<1200xf64>
        ...
        %3 = affine.load %alloc_7[%arg1] : memref<1200xf64>
        %4 = arith.mulf %3, %cst : f64
        %5 = arith.divf %2, %4 : f64
        affine.store %5, %alloc[%arg0, %arg1] : memref<1400x1200xf64>
      }
    }
    affine.for %arg0 = 0 to 1199 {
      affine.store %cst_0, %alloc_5[%arg0, %arg0] : memref<1200x1200xf64>
      affine.for %arg1 = #map(%arg0) to 1200 {
        affine.store %cst_1, %alloc_5[%arg0, %arg1] : memref<1200x1200xf64>
        affine.for %arg2 = 0 to 1400 {
          %1 = affine.load %alloc[%arg2, %arg0] : memref<1400x1200xf64>
          %2 = affine.load %alloc[%arg2, %arg1] : memref<1400x1200xf64>
          %3 = arith.mulf %1, %2 : f64
          %4 = affine.load %alloc_5[%arg0, %arg1] : memref<1200x1200xf64>
          %5 = arith.addf %4, %3 : f64
          affine.store %5, %alloc_5[%arg0, %arg1] : memref<1200x1200xf64>
        }
        %0 = affine.load %alloc_5[%arg0, %arg1] : memref<1200x1200xf64>
        affine.store %0, %alloc_5[%arg1, %arg0] : memref<1200x1200xf64>
      }
    }
    ...
    scf.for %arg0 = %c0 to %c1200 step %c1 {
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        %0 = memref.load %alloc_5[%arg0, %arg1] : memref<1200x1200xf64>
