  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    affine.for %arg0 = 0 to 1200 {
      ...
      affine.for %arg1 = 0 to 1000 {
        %3 = affine.load %alloc[%arg1, %arg0] : memref<1000x1200xf64>
      ...
      %2 = math.sqrt %1 : f64
      affine.store %2, %alloc_3[%arg0, %arg0] : memref<1200x1200xf64>
      affine.for %arg1 = 0 to 1000 {
        %3 = affine.load %alloc[%arg1, %arg0] : memref<1000x1200xf64>
        %4 = arith.divf %3, %2 : f64
        affine.store %4, %alloc_4[%arg1, %arg0] : memref<1000x1200xf64>
      }
      affine.for %arg1 = #map(%arg0) to 1200 {
        affine.store %cst_2, %alloc_3[%arg0, %arg1] : memref<1200x1200xf64>
        affine.for %arg2 = 0 to 1000 {
          %4 = affine.load %alloc_4[%arg2, %arg0] : memref<1000x1200xf64>
          %5 = affine.load %alloc[%arg2, %arg1] : memref<1000x1200xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %alloc_3[%arg0, %arg1] : memref<1200x1200xf64>
          %8 = arith.addf %7, %6 : f64
          affine.store %8, %alloc_3[%arg0, %arg1] : memref<1200x1200xf64>
        }
        %3 = affine.load %alloc_3[%arg0, %arg1] : memref<1200x1200xf64>
        affine.for %arg2 = 0 to 1000 {
          %4 = affine.load %alloc[%arg2, %arg1] : memref<1000x1200xf64>
          %5 = affine.load %alloc_4[%arg2, %arg0] : memref<1000x1200xf64>
          %6 = arith.mulf %5, %3 : f64
          %7 = arith.subf %4, %6 : f64
          affine.store %7, %alloc[%arg2, %arg1] : memref<1000x1200xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c1200 step %c1 {
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        %1 = memref.load %alloc_3[%arg0, %arg1] : memref<1200x1200xf64>
    ...
    scf.for %arg0 = %c0 to %c1000 step %c1 {
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        %1 = memref.load %alloc_4[%arg0, %arg1] : memref<1000x1200xf64>
        %2 = arith.fptosi %1 : f64 to i32
        func.call @print_i32(%2) : (i32) -> ()
      }
    }
