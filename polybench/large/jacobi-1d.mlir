  ...
  func.func @main() -> i32 {
    ...
    affine.for %arg0 = 0 to 500 {
      affine.for %arg1 = 1 to 1999 {
        %0 = affine.load %alloc[%arg1 - 1] : memref<2000xf64>
        %1 = affine.load %alloc[%arg1] : memref<2000xf64>
        %2 = arith.addf %0, %1 : f64
        %3 = affine.load %alloc[%arg1 + 1] : memref<2000xf64>
        %4 = arith.addf %2, %3 : f64
        %5 = arith.mulf %4, %cst_0 : f64
        affine.store %5, %alloc_3[%arg1] : memref<2000xf64>
      }
      affine.for %arg1 = 1 to 1999 {
        %0 = affine.load %alloc_3[%arg1 - 1] : memref<2000xf64>
        %1 = affine.load %alloc_3[%arg1] : memref<2000xf64>
        %2 = arith.addf %0, %1 : f64
        %3 = affine.load %alloc_3[%arg1 + 1] : memref<2000xf64>
        %4 = arith.addf %2, %3 : f64
        %5 = arith.mulf %4, %cst_0 : f64
        affine.store %5, %alloc[%arg1] : memref<2000xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c2000 step %c1 {
