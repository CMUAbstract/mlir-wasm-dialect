    ...
    affine.for %arg0 = 0 to 2000 {
      affine.for %arg1 = 0 to #map(%arg0) {
        affine.for %arg2 = 0 to #map(%arg1) {
          ...
          affine.store %7, %alloc[%arg0, %arg1] : memref<2000x2000xf64>
        }
        %0 = affine.load %alloc[%arg1, %arg1] : memref<2000x2000xf64>
      ...
      affine.for %arg1 = #map(%arg0) to 2000 {
        affine.for %arg2 = 0 to #map(%arg0) {
          %0 = affine.load %alloc[%arg0, %arg2] : memref<2000x2000xf64>
          %1 = affine.load %alloc[%arg2, %arg1] : memref<2000x2000xf64>
          %2 = arith.mulf %0, %1 : f64
