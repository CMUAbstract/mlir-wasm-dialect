    ...
    affine.for %arg0 = 0 to 500 {
      affine.for %arg1 = 1 to 1999 {
        affine.for %arg2 = 1 to 1999 {
          %0 = affine.load %alloc[%arg1 - 1, %arg2 - 1] : memref<2000x2000xf64>
          %1 = affine.load %alloc[%arg1 - 1, %arg2] : memref<2000x2000xf64>
          %2 = arith.addf %0, %1 : f64
          %3 = affine.load %alloc[%arg1 - 1, %arg2 + 1] : memref<2000x2000xf64>
          %4 = arith.addf %2, %3 : f64
          %5 = affine.load %alloc[%arg1, %arg2 - 1] : memref<2000x2000xf64>
          %6 = arith.addf %4, %5 : f64
          %7 = affine.load %alloc[%arg1, %arg2] : memref<2000x2000xf64>
          %8 = arith.addf %6, %7 : f64
          %9 = affine.load %alloc[%arg1, %arg2 + 1] : memref<2000x2000xf64>
          %10 = arith.addf %8, %9 : f64
          %11 = affine.load %alloc[%arg1 + 1, %arg2 - 1] : memref<2000x2000xf64>
          %12 = arith.addf %10, %11 : f64
          %13 = affine.load %alloc[%arg1 + 1, %arg2] : memref<2000x2000xf64>
          %14 = arith.addf %12, %13 : f64
          %15 = affine.load %alloc[%arg1 + 1, %arg2 + 1] : memref<2000x2000xf64>
          %16 = arith.addf %14, %15 : f64
          %17 = arith.divf %16, %cst_0 : f64
          affine.store %17, %alloc[%arg1, %arg2] : memref<2000x2000xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
