module {
  func.func @main() -> i32 {
    ...
    affine.for %arg0 = 0 to 500 {
      affine.for %arg1 = 1 to 1299 {
        affine.for %arg2 = 1 to 1299 {
          %0 = affine.load %alloc[%arg1, %arg2] : memref<1300x1300xf64>
          %1 = affine.load %alloc[%arg1, %arg2 - 1] : memref<1300x1300xf64>
          %2 = arith.addf %0, %1 : f64
          %3 = affine.load %alloc[%arg1, %arg2 + 1] : memref<1300x1300xf64>
          %4 = arith.addf %2, %3 : f64
          %5 = affine.load %alloc[%arg1 + 1, %arg2] : memref<1300x1300xf64>
          %6 = arith.addf %4, %5 : f64
          %7 = affine.load %alloc[%arg1 - 1, %arg2] : memref<1300x1300xf64>
          %8 = arith.addf %6, %7 : f64
          %9 = arith.mulf %8, %cst_0 : f64
          affine.store %9, %alloc_3[%arg1, %arg2] : memref<1300x1300xf64>
        }
      }
      affine.for %arg1 = 1 to 1299 {
        affine.for %arg2 = 1 to 1299 {
          %0 = affine.load %alloc_3[%arg1, %arg2] : memref<1300x1300xf64>
          %1 = affine.load %alloc_3[%arg1, %arg2 - 1] : memref<1300x1300xf64>
          %2 = arith.addf %0, %1 : f64
          %3 = affine.load %alloc_3[%arg1, %arg2 + 1] : memref<1300x1300xf64>
          %4 = arith.addf %2, %3 : f64
          %5 = affine.load %alloc_3[%arg1 + 1, %arg2] : memref<1300x1300xf64>
          %6 = arith.addf %4, %5 : f64
          %7 = affine.load %alloc_3[%arg1 - 1, %arg2] : memref<1300x1300xf64>
          %8 = arith.addf %6, %7 : f64
          %9 = arith.mulf %8, %cst_0 : f64
          affine.store %9, %alloc[%arg1, %arg2] : memref<1300x1300xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c1300 step %c1 {
      scf.for %arg1 = %c0 to %c1300 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<1300x1300xf64>
