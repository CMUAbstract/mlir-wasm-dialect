  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c2600 step %c1 {
        ...
        memref.store %10, %alloc_3[%arg0, %arg1] : memref<2000x2600xf64>
        %11 = arith.addi %2, %c3_i32 : i32
        %12 = arith.sitofp %11 : i32 to f64
        %13 = arith.mulf %1, %12 : f64
        %14 = arith.divf %13, %cst_0 : f64
        memref.store %14, %alloc_4[%arg0, %arg1] : memref<2000x2600xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 1000 {
      ...
      affine.for %arg1 = 0 to 2600 {
        affine.store %1, %alloc_3[0, %arg1] : memref<2000x2600xf64>
      }
      affine.for %arg1 = 1 to 2000 {
        affine.for %arg2 = 0 to 2600 {
          %2 = affine.load %alloc_3[%arg1, %arg2] : memref<2000x2600xf64>
          %3 = affine.load %alloc_4[%arg1, %arg2] : memref<2000x2600xf64>
          %4 = affine.load %alloc_4[%arg1 - 1, %arg2] : memref<2000x2600xf64>
          %5 = arith.subf %3, %4 : f64
          %6 = arith.mulf %5, %cst_2 : f64
          %7 = arith.subf %2, %6 : f64
          affine.store %7, %alloc_3[%arg1, %arg2] : memref<2000x2600xf64>
        }
      }
      affine.for %arg1 = 0 to 2000 {
        affine.for %arg2 = 1 to 2600 {
          %2 = affine.load %alloc[%arg1, %arg2] : memref<2000x2600xf64>
          %3 = affine.load %alloc_4[%arg1, %arg2] : memref<2000x2600xf64>
          %4 = affine.load %alloc_4[%arg1, %arg2 - 1] : memref<2000x2600xf64>
          %5 = arith.subf %3, %4 : f64
          %6 = arith.mulf %5, %cst_2 : f64
          %7 = arith.subf %2, %6 : f64
          affine.store %7, %alloc[%arg1, %arg2] : memref<2000x2600xf64>
        }
      }
      affine.for %arg1 = 0 to 1999 {
        affine.for %arg2 = 0 to 2599 {
          %2 = affine.load %alloc_4[%arg1, %arg2] : memref<2000x2600xf64>
          %3 = affine.load %alloc[%arg1, %arg2 + 1] : memref<2000x2600xf64>
          %4 = affine.load %alloc[%arg1, %arg2] : memref<2000x2600xf64>
          %5 = arith.subf %3, %4 : f64
          %6 = affine.load %alloc_3[%arg1 + 1, %arg2] : memref<2000x2600xf64>
          %7 = arith.addf %5, %6 : f64
          %8 = affine.load %alloc_3[%arg1, %arg2] : memref<2000x2600xf64>
          %9 = arith.subf %7, %8 : f64
          %10 = arith.mulf %9, %cst_1 : f64
          %11 = arith.subf %2, %10 : f64
          affine.store %11, %alloc_4[%arg1, %arg2] : memref<2000x2600xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      scf.for %arg1 = %c0 to %c2600 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<2000x2600xf64>
    ...
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      scf.for %arg1 = %c0 to %c2600 step %c1 {
        %0 = memref.load %alloc_4[%arg0, %arg1] : memref<2000x2600xf64>
        %1 = arith.fptosi %0 : f64 to i32
        func.call @print_i32(%1) : (i32) -> ()
      }
    }
