  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg0 = 0 to 2600 {
      ...
      affine.for %arg1 = 0 to 2000 {
        ...
        %7 = arith.mulf %6, %cst_1 : f64
        affine.for %arg2 = 0 to #map(%arg0) {
          %8 = arith.index_cast %arg2 : index to i32
          %9 = arith.muli %8, %1 : i32
          %10 = arith.addi %9, %c1_i32 : i32
          %11 = arith.remsi %10, %c2600_i32 : i32
          %12 = arith.sitofp %11 : i32 to f64
          %13 = arith.divf %12, %cst_0 : f64
          %14 = arith.mulf %7, %13 : f64
          %15 = affine.load %alloc[%arg0, %arg2] : memref<2600x2600xf64>
          %16 = arith.addf %15, %14 : f64
          affine.store %16, %alloc[%arg0, %arg2] : memref<2600x2600xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
