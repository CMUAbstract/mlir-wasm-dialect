...
module {
  func.func @main() -> i32 {
    ...
    %alloc = memref.alloc() : memref<80x80xf64>
    scf.for %arg0 = %c0 to %c80 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c80 step %c1 {
        ...
        memref.store %6, %alloc[%arg0, %arg1] : memref<80x80xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 80 {
      affine.for %arg1 = 0 to #map(%arg0) {
        %1 = affine.load %alloc[%arg0, %arg1] : memref<80x80xf64>
        %2 = arith.mulf %1, %cst_2 : f64
        affine.store %2, %alloc[%arg0, %arg1] : memref<80x80xf64>
      }
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 60 {
        ...
        affine.for %arg2 = 0 to #map(%arg0) {
          ...
          %26 = affine.load %alloc[%arg0, %arg2] : memref<80x80xf64>
          %27 = arith.addf %26, %25 : f64
          affine.store %27, %alloc[%arg0, %arg2] : memref<80x80xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c80 step %c1 {
      scf.for %arg1 = %c0 to %c80 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<80x80xf64>
        %1 = arith.fptosi %0 : f64 to i32
        func.call @print_i32(%1) : (i32) -> ()
      }
    }
    memref.dealloc %alloc : memref<80x80xf64>
    return %c0_i32 : i32
  }
