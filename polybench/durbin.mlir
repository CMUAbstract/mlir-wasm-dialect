...
module {
  func.func @main() -> i32 {
    %cst = arith.constant -1.210000e+02 : f64
    ...
    %alloca_4 = memref.alloca() : memref<120xf64>
    affine.store %cst, %alloc[0] : memref<120xf64>
    affine.store %cst_0, %alloca_2[] : memref<f64>
    affine.store %cst, %alloca_3[] : memref<f64>
    affine.for %arg0 = 1 to 120 {
      ...
      affine.for %arg1 = 0 to #map(%arg0) {
        ...
        %15 = arith.subi %c121_i32, %14 : i32
        %16 = arith.sitofp %15 : i32 to f64
        %17 = affine.load %alloc[%arg1] : memref<120xf64>
      ...
      affine.for %arg1 = 0 to #map(%arg0) {
        %13 = affine.load %alloc[%arg1] : memref<120xf64>
        %14 = affine.load %alloc[%arg0 - %arg1 - 1] : memref<120xf64>
        %15 = arith.mulf %12, %14 : f64
        %16 = arith.addf %13, %15 : f64
        affine.store %16, %alloca_4[%arg1] : memref<120xf64>
      }
      affine.for %arg1 = 0 to #map(%arg0) {
        %13 = affine.load %alloca_4[%arg1] : memref<120xf64>
        affine.store %13, %alloc[%arg1] : memref<120xf64>
      }
      affine.store %12, %alloc[%arg0] : memref<120xf64>
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c120 step %c1 {
      %1 = memref.load %alloc[%arg0] : memref<120xf64>
