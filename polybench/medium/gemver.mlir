module {
  func.func @main() -> i32 {
    ...
    %alloc_8 = memref.alloc() : memref<400xf64>
    %alloc_9 = memref.alloc() : memref<400xf64>
    scf.for %arg0 = %c0 to %c400 step %c1 {
      %0 = arith.index_cast %arg0 : index to i32
      memref.store %cst_7, %alloc_9[%arg0] : memref<400xf64>
      memref.store %cst_7, %alloc_8[%arg0] : memref<400xf64>
      scf.for %arg1 = %c0 to %c400 step %c1 {
        %1 = arith.index_cast %arg1 : index to i32
        %2 = arith.muli %0, %1 : i32
        %3 = arith.remsi %2, %c400_i32 : i32
        %4 = arith.sitofp %3 : i32 to f64
        %5 = arith.divf %4, %cst : f64
        memref.store %5, %alloc[%arg0, %arg1] : memref<400x400xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 400 {
      ...
      affine.for %arg1 = 0 to 400 {
        ...
        affine.store %16, %alloc[%arg0, %arg1] : memref<400x400xf64>
      }
    }
    affine.for %arg0 = 0 to 400 {
      affine.for %arg1 = 0 to 400 {
        %0 = affine.load %alloc_9[%arg0] : memref<400xf64>
        %1 = affine.load %alloc[%arg1, %arg0] : memref<400x400xf64>
        ...
        affine.store %9, %alloc_9[%arg0] : memref<400xf64>
      }
    }
    affine.for %arg0 = 0 to 400 {
      %0 = affine.load %alloc_9[%arg0] : memref<400xf64>
      ...
      affine.store %6, %alloc_9[%arg0] : memref<400xf64>
    }
    affine.for %arg0 = 0 to 400 {
      affine.for %arg1 = 0 to 400 {
        %0 = affine.load %alloc_8[%arg0] : memref<400xf64>
        %1 = affine.load %alloc[%arg0, %arg1] : memref<400x400xf64>
        %2 = arith.mulf %1, %cst_0 : f64
        %3 = affine.load %alloc_9[%arg1] : memref<400xf64>
        %4 = arith.mulf %2, %3 : f64
        %5 = arith.addf %0, %4 : f64
        affine.store %5, %alloc_8[%arg0] : memref<400xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c400 step %c1 {
      %0 = memref.load %alloc_8[%arg0] : memref<400xf64>
      %1 = arith.fptosi %0 : f64 to i32
      func.call @print_i32(%1) : (i32) -> ()
    }
    memref.dealloc %alloc : memref<400x400xf64>
    memref.dealloc %alloc_8 : memref<400xf64>
    memref.dealloc %alloc_9 : memref<400xf64>
    return %c0_i32 : i32
  }
