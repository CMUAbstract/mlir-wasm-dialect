...
module {
  func.func @main() -> i32 attributes { exported } {
    ...
    affine.for %arg0 = 0 to 400 {
      affine.for %arg1 = 0 to #map(%arg0) {
        affine.for %arg2 = 0 to #map(%arg1) {
          ...
          %6 = affine.load %alloc[%arg0, %arg1] : memref<400x400xf64>
          %7 = arith.subf %6, %5 : f64
          affine.store %7, %alloc[%arg0, %arg1] : memref<400x400xf64>
        }
        %0 = affine.load %alloc[%arg1, %arg1] : memref<400x400xf64>
      ...
      affine.for %arg1 = #map(%arg0) to 400 {
        affine.for %arg2 = 0 to #map(%arg0) {
          %0 = affine.load %alloc[%arg0, %arg2] : memref<400x400xf64>
          %1 = affine.load %alloc[%arg2, %arg1] : memref<400x400xf64>
          %2 = arith.mulf %0, %1 : f64
    ...
    scf.for %arg0 = %c0 to %c400 step %c1 {
      scf.for %arg1 = %c0 to %c400 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<400x400xf64>
