...
module {
  func.func @main() -> i32 {
    %cst = arith.constant 2.005000e+00 : f64
    %c400 = arith.constant 400 : index
    %cst_0 = arith.constant 4.000000e+02 : f64
    ...
    scf.for %arg0 = %c0 to %c400 step %c1 {
      memref.store %cst_1, %alloc[%arg0] : memref<400xf64>
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 400 {
      %0 = arith.index_cast %arg0 : index to i32
      %1 = arith.sitofp %0 : i32 to f64
      affine.store %1, %alloc[%arg0] : memref<400xf64>
      %2 = arith.addi %0, %c400_i32 : i32
      affine.for %arg1 = 0 to #map(%arg0) {
        ...
        %11 = affine.load %alloc[%arg1] : memref<400xf64>
        %12 = arith.mulf %10, %11 : f64
        %13 = affine.load %alloc[%arg0] : memref<400xf64>
        %14 = arith.subf %13, %12 : f64
        affine.store %14, %alloc[%arg0] : memref<400xf64>
      }
      %3 = affine.load %alloc[%arg0] : memref<400xf64>
      %4 = arith.divf %3, %cst : f64
      affine.store %4, %alloc[%arg0] : memref<400xf64>
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c400 step %c1 {
