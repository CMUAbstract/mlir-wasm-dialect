module {
  func.func @main() -> i32 {
    ...
    %cst = arith.constant 2.100000e+02 : f64
    %cst_0 = arith.constant 2.200000e+02 : f64
    %cst_1 = arith.constant 1.900000e+02 : f64
    ...
    %alloc_6 = memref.alloc() : memref<180x220xf64>
    scf.for %arg0 = %c0 to %c180 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c220 step %c1 {
        ...
        %4 = arith.remsi %3, %c210_i32 : i32
        %5 = arith.sitofp %4 : i32 to f64
        %6 = arith.divf %5, %cst : f64
        memref.store %6, %alloc_6[%arg0, %arg1] : memref<180x220xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    ...
    affine.for %arg0 = 0 to 180 {
      affine.for %arg1 = 0 to 220 {
        %0 = affine.load %alloc_6[%arg0, %arg1] : memref<180x220xf64>
        %1 = arith.mulf %0, %cst_5 : f64
        affine.store %1, %alloc_6[%arg0, %arg1] : memref<180x220xf64>
        %2 = arith.index_cast %arg1 : index to i32
        %3 = arith.addi %2, %c3_i32 : i32
        affine.for %arg2 = 0 to 190 {
          %4 = affine.load %alloc[%arg0, %arg2] : memref<180x190xf64>
          %5 = arith.index_cast %arg2 : index to i32
          %6 = arith.muli %5, %3 : i32
          %7 = arith.addi %6, %c1_i32 : i32
          %8 = arith.remsi %7, %c220_i32 : i32
          %9 = arith.sitofp %8 : i32 to f64
          %10 = arith.divf %9, %cst_0 : f64
          %11 = arith.mulf %4, %10 : f64
          %12 = affine.load %alloc_6[%arg0, %arg1] : memref<180x220xf64>
          %13 = arith.addf %12, %11 : f64
          affine.store %13, %alloc_6[%arg0, %arg1] : memref<180x220xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c180 step %c1 {
      scf.for %arg1 = %c0 to %c220 step %c1 {
        %0 = memref.load %alloc_6[%arg0, %arg1] : memref<180x220xf64>
        %1 = arith.fptosi %0 : f64 to i32
        func.call @print_i32(%1) : (i32) -> ()
      }
    }
    memref.dealloc %alloc : memref<180x190xf64>
    memref.dealloc %alloc_6 : memref<180x220xf64>
    return %c0_i32 : i32
  }
