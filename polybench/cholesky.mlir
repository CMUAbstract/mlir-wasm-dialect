    ...
    affine.for %arg0 = 0 to 4000 {
      affine.for %arg1 = 0 to #map(%arg0) {
        affine.for %arg2 = 0 to #map(%arg1) {
          ...
          %6 = affine.load %alloc[%arg1, %arg2] : memref<4000x4000xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %alloc[%arg0, %arg1] : memref<4000x4000xf64>
          %9 = arith.subf %8, %7 : f64
          affine.store %9, %alloc[%arg0, %arg1] : memref<4000x4000xf64>
        }
        %2 = affine.load %alloc[%arg1, %arg1] : memref<4000x4000xf64>
      ...
      affine.for %arg1 = 0 to #map(%arg0) {
        %2 = affine.load %alloc[%arg0, %arg1] : memref<4000x4000xf64>
        %3 = arith.mulf %2, %2 : f64
        %4 = affine.load %alloc[%arg0, %arg0] : memref<4000x4000xf64>
        %5 = arith.subf %4, %3 : f64
        affine.store %5, %alloc[%arg0, %arg0] : memref<4000x4000xf64>
      }
      %0 = affine.load %alloc[%arg0, %arg0] : memref<4000x4000xf64>
      %1 = math.sqrt %0 : f64
      affine.store %1, %alloc[%arg0, %arg0] : memref<4000x4000xf64>
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c4000 step %c1 {
      %0 = arith.index_cast %arg0 : index to i32
      ...
      %2 = arith.index_cast %1 : i32 to index
      scf.for %arg1 = %c0 to %2 step %c1 {
        %3 = memref.load %alloc[%arg0, %arg1] : memref<4000x4000xf64>
