...
module {
  func.func @main() -> i32 {
    ...
    %alloc_4 = memref.alloc() : memref<60x60xf64>
    ...
    scf.for %arg0 = %c0 to %c60 step %c1 {
      ...
      scf.for %arg1 = %c0 to %3 step %c1 {
        ...
        memref.store %8, %alloc_4[%arg0, %arg1] : memref<60x60xf64>
      }
      scf.for %arg1 = %3 to %c60 step %c1 {
        memref.store %cst_3, %alloc_4[%arg0, %arg1] : memref<60x60xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    ...
    affine.for %arg0 = 0 to 60 {
      %1 = arith.index_cast %arg0 : index to i32
      %2 = arith.addi %1, %c80_i32 : i32
      %3 = arith.index_cast %arg0 : index to i32
      %4 = arith.addi %3, %c80_i32 : i32
      %5 = affine.load %alloc_4[%arg0, %arg0] : memref<60x60xf64>
      affine.for %arg1 = 0 to 80 {
        ...
        affine.for %arg2 = 0 to #map(%arg0) {
          %25 = affine.load %alloc_4[%arg0, %arg2] : memref<60x60xf64>
          %26 = arith.mulf %11, %25 : f64
          %27 = affine.load %alloc[%arg2, %arg1] : memref<60x80xf64>
          %28 = arith.addf %27, %26 : f64
          affine.store %28, %alloc[%arg2, %arg1] : memref<60x80xf64>
          %29 = arith.index_cast %arg2 : index to i32
          %30 = arith.addi %29, %c80_i32 : i32
        ...
        %12 = affine.load %alloc[%arg0, %arg1] : memref<60x80xf64>
        ...
        affine.store %24, %alloc[%arg0, %arg1] : memref<60x80xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c60 step %c1 {
      scf.for %arg1 = %c0 to %c80 step %c1 {
        %1 = memref.load %alloc[%arg0, %arg1] : memref<60x80xf64>
        %2 = arith.fptosi %1 : f64 to i32
        func.call @print_i32(%2) : (i32) -> ()
      }
    }
    memref.dealloc %alloc : memref<60x80xf64>
    memref.dealloc %alloc_4 : memref<60x60xf64>
    return %c0_i32 : i32
  }
