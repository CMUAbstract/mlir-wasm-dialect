module {
  func.func @main() -> i32 attributes { exported } {
    ...
    %cst_1 = arith.constant 6.000000e+01 : f64
    ...
    %alloc = memref.alloc() : memref<60x70xf64>
    scf.for %arg0 = %c0 to %c60 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c70 step %c1 {
        ...
        memref.store %6, %alloc[%arg0, %arg1] : memref<60x70xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 60 {
      affine.for %arg1 = 0 to 70 {
        %1 = affine.load %alloc[%arg0, %arg1] : memref<60x70xf64>
        %2 = arith.mulf %1, %cst_3 : f64
        affine.store %2, %alloc[%arg0, %arg1] : memref<60x70xf64>
      }
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 80 {
        ...
        affine.for %arg2 = 0 to 70 {
          ...
          %11 = arith.remsi %10, %c70_i32 : i32
          %12 = arith.sitofp %11 : i32 to f64
          %13 = arith.divf %12, %cst : f64
          %14 = arith.mulf %7, %13 : f64
          %15 = affine.load %alloc[%arg0, %arg2] : memref<60x70xf64>
          %16 = arith.addf %15, %14 : f64
          affine.store %16, %alloc[%arg0, %arg2] : memref<60x70xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c60 step %c1 {
      scf.for %arg1 = %c0 to %c70 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<60x70xf64>
        %1 = arith.fptosi %0 : f64 to i32
        func.call @print_i32(%1) : (i32) -> ()
      }
    }
    memref.dealloc %alloc : memref<60x70xf64>
    return %c0_i32 : i32
  }
