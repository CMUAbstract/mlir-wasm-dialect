...
module {
  func.func @main() -> i32 {
    ...
    %alloc_4 = memref.alloc() : memref<80xf64>
    scf.for %arg0 = %c0 to %c100 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c80 step %c1 {
        ...
        memref.store %5, %alloc[%arg0, %arg1] : memref<100x80xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 80 {
      affine.store %cst_1, %alloc_4[%arg0] : memref<80xf64>
      %0 = arith.index_cast %arg0 : index to i32
      %1 = arith.sitofp %0 : i32 to f64
      affine.for %arg1 = 0 to 100 {
        ...
        %8 = affine.load %alloc_4[%arg0] : memref<80xf64>
        %9 = arith.addf %8, %7 : f64
        affine.store %9, %alloc_4[%arg0] : memref<80xf64>
      }
      %2 = affine.load %alloc_4[%arg0] : memref<80xf64>
      %3 = arith.divf %2, %cst_0 : f64
      affine.store %3, %alloc_4[%arg0] : memref<80xf64>
    }
    affine.for %arg0 = 0 to 100 {
      affine.for %arg1 = 0 to 80 {
        %0 = affine.load %alloc_4[%arg1] : memref<80xf64>
    ...
    affine.for %arg0 = 0 to 80 {
      affine.for %arg1 = #map(%arg0) to 80 {
        affine.store %cst_1, %alloc_3[%arg0, %arg1] : memref<80x80xf64>
        affine.for %arg2 = 0 to 100 {
          %2 = affine.load %alloc[%arg2, %arg0] : memref<100x80xf64>
          %3 = affine.load %alloc[%arg2, %arg1] : memref<100x80xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = affine.load %alloc_3[%arg0, %arg1] : memref<80x80xf64>
          %6 = arith.addf %5, %4 : f64
          affine.store %6, %alloc_3[%arg0, %arg1] : memref<80x80xf64>
        }
        %0 = affine.load %alloc_3[%arg0, %arg1] : memref<80x80xf64>
        %1 = arith.divf %0, %cst : f64
        affine.store %1, %alloc_3[%arg0, %arg1] : memref<80x80xf64>
        affine.store %1, %alloc_3[%arg1, %arg0] : memref<80x80xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c80 step %c1 {
      scf.for %arg1 = %c0 to %c80 step %c1 {
        %0 = memref.load %alloc_3[%arg0, %arg1] : memref<80x80xf64>
    ...
    memref.dealloc %alloc_4 : memref<80xf64>
    return %c0_i32 : i32
  }
