module {
  func.func @main() -> i32 attributes { exported } {
    ...
    %alloc_0 = memref.alloc() : memref<120xf64>
    scf.for %arg0 = %c0 to %c120 step %c1 {
      %0 = arith.index_cast %arg0 : index to i32
      %1 = arith.remsi %0, %c120_i32 : i32
    ...
    affine.for %arg0 = 0 to 120 {
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 120 {
        %1 = affine.load %alloc_0[%arg0] : memref<120xf64>
        %2 = arith.index_cast %arg1 : index to i32
        ...
        %11 = arith.mulf %6, %10 : f64
        %12 = arith.addf %1, %11 : f64
        affine.store %12, %alloc_0[%arg0] : memref<120xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c120 step %c1 {
    ...
    scf.for %arg0 = %c0 to %c120 step %c1 {
      %0 = memref.load %alloc_0[%arg0] : memref<120xf64>
      %1 = arith.fptosi %0 : f64 to i32
      func.call @print_i32(%1) : (i32) -> ()
    }
    memref.dealloc %alloc : memref<120xf64>
    memref.dealloc %alloc_0 : memref<120xf64>
    return %c0_i32 : i32
  }
