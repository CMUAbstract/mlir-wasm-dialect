  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    scf.for %arg0 = %c0 to %c180 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c180 step %c1 {
        ...
        memref.store %4, %alloc[%arg0, %arg1] : memref<180x180xi32>
        ...
        scf.if %9 {
          memref.store %c999_i32, %alloc[%arg0, %arg1] : memref<180x180xi32>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 180 {
      affine.for %arg1 = 0 to 180 {
        affine.for %arg2 = 0 to 180 {
          %0 = affine.load %alloc[%arg1, %arg2] : memref<180x180xi32>
          %1 = affine.load %alloc[%arg1, %arg0] : memref<180x180xi32>
          %2 = affine.load %alloc[%arg0, %arg2] : memref<180x180xi32>
          %3 = arith.addi %1, %2 : i32
          %4 = arith.cmpi slt, %0, %3 : i32
          %5 = arith.select %4, %0, %3 : i32
          affine.store %5, %alloc[%arg1, %arg2] : memref<180x180xi32>
        }
      }
    }
    call @toggle_gpio() : () -> ()
