...
static void *app_instance_main(wasm_module_inst_t module_inst,
  ...
  TensorData arg0_tensor = initialize_tensor(module_inst, exec_env,
                                             /*tensor_size=*/SIZE, data1d);
  TensorData arg1_tensor = initialize_tensor(module_inst, exec_env,
                                             /*tensor_size=*/SIZE, data1d);
  TensorData arg2_tensor = initialize_tensor(module_inst, exec_env,
                                             /*tensor_size=*/SIZE, data1d);
  TensorData arg3_tensor = initialize_tensor(module_inst, exec_env,
                                             /*tensor_size=*/SIZE, data1d);
  ...
  // setup arguments
  argv[0] = arg0_tensor.tensor_ptr;
  argv[1] = arg1_tensor.tensor_ptr;
