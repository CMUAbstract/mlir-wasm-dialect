  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    scf.for %arg0 = %c0 to %c200 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c240 step %c1 {
        ...
        memref.store %6, %alloc_3[%arg0, %arg1] : memref<200x240xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 200 {
      affine.for %arg1 = 0 to 240 {
        affine.for %arg2 = #map(%arg0) to 200 {
          %2 = affine.load %alloc[%arg2, %arg0] : memref<200x200xf64>
          %3 = affine.load %alloc_3[%arg2, %arg1] : memref<200x240xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = affine.load %alloc_3[%arg0, %arg1] : memref<200x240xf64>
          %6 = arith.addf %5, %4 : f64
          affine.store %6, %alloc_3[%arg0, %arg1] : memref<200x240xf64>
        }
        %0 = affine.load %alloc_3[%arg0, %arg1] : memref<200x240xf64>
        %1 = arith.mulf %0, %cst_1 : f64
        affine.store %1, %alloc_3[%arg0, %arg1] : memref<200x240xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c200 step %c1 {
