module {
  func.func @main() -> i32 attributes { exported } {
    ...
    %alloc_3 = memref.alloc() : memref<400xf64>
    scf.for %arg0 = %c0 to %c400 step %c1 {
      ...
      memref.store %5, %alloc_3[%arg0] : memref<400xf64>
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 100 {
      affine.for %arg1 = 1 to 399 {
        %0 = affine.load %alloc[%arg1 - 1] : memref<400xf64>
        %1 = affine.load %alloc[%arg1] : memref<400xf64>
        %2 = arith.addf %0, %1 : f64
        %3 = affine.load %alloc[%arg1 + 1] : memref<400xf64>
        %4 = arith.addf %2, %3 : f64
        %5 = arith.mulf %4, %cst_0 : f64
        affine.store %5, %alloc_3[%arg1] : memref<400xf64>
      }
      affine.for %arg1 = 1 to 399 {
        %0 = affine.load %alloc_3[%arg1 - 1] : memref<400xf64>
        %1 = affine.load %alloc_3[%arg1] : memref<400xf64>
        %2 = arith.addf %0, %1 : f64
        %3 = affine.load %alloc_3[%arg1 + 1] : memref<400xf64>
        %4 = arith.addf %2, %3 : f64
        %5 = arith.mulf %4, %cst_0 : f64
        affine.store %5, %alloc[%arg1] : memref<400xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c400 step %c1 {
    ...
    memref.dealloc %alloc_3 : memref<400xf64>
    return %c0_i32 : i32
  }
