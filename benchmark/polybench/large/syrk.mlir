  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    scf.for %arg0 = %c0 to %c1200 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        ...
        memref.store %6, %alloc[%arg0, %arg1] : memref<1200x1200xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 1200 {
      affine.for %arg1 = 0 to #map(%arg0) {
        %1 = affine.load %alloc[%arg0, %arg1] : memref<1200x1200xf64>
        %2 = arith.mulf %1, %cst_2 : f64
        affine.store %2, %alloc[%arg0, %arg1] : memref<1200x1200xf64>
      }
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 1000 {
        ...
        affine.for %arg2 = 0 to #map(%arg0) {
          ...
          %11 = arith.remsi %10, %c1200_i32 : i32
          %12 = arith.sitofp %11 : i32 to f64
          %13 = arith.divf %12, %cst_0 : f64
          %14 = arith.mulf %7, %13 : f64
          %15 = affine.load %alloc[%arg0, %arg2] : memref<1200x1200xf64>
          %16 = arith.addf %15, %14 : f64
          affine.store %16, %alloc[%arg0, %arg2] : memref<1200x1200xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c1200 step %c1 {
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<1200x1200xf64>
