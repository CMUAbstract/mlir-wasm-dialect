module {
  func.func @main() -> i32 attributes { exported } {
    ...
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      ...
      memref.store %7, %alloc_0[%arg0] : memref<2000xf64>
    }
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 2000 {
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 2000 {
        %1 = affine.load %alloc[%arg0] : memref<2000xf64>
    ...
    affine.for %arg0 = 0 to 2000 {
      %0 = arith.index_cast %arg0 : index to i32
      affine.for %arg1 = 0 to 2000 {
        %1 = affine.load %alloc_0[%arg0] : memref<2000xf64>
        %2 = arith.index_cast %arg1 : index to i32
        ...
        %11 = arith.mulf %6, %10 : f64
        %12 = arith.addf %1, %11 : f64
        affine.store %12, %alloc_0[%arg0] : memref<2000xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c2000 step %c1 {
