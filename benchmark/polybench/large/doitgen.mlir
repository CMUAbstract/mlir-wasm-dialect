module {
  func.func @kernel_doitgen(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x140x160xf64>, %arg4: memref<?x160xf64>, %arg5: memref<?xf64>) {
  ...
  func.func @main() -> i32 attributes { exported } {
    ...
    call @toggle_gpio() : () -> ()
    affine.for %arg0 = 0 to 150 {
      affine.for %arg1 = 0 to 140 {
        affine.for %arg2 = 0 to 160 {
          affine.store %cst_0, %alloc_1[%arg2] : memref<160xf64>
          %0 = arith.index_cast %arg2 : index to i32
          affine.for %arg3 = 0 to 160 {
            %1 = affine.load %alloc[%arg0, %arg1, %arg3] : memref<150x140x160xf64>
            %2 = arith.index_cast %arg3 : index to i32
            %3 = arith.muli %2, %0 : i32
            %4 = arith.remsi %3, %c160_i32 : i32
            %5 = arith.sitofp %4 : i32 to f64
            %6 = arith.divf %5, %cst : f64
            %7 = arith.mulf %1, %6 : f64
            %8 = affine.load %alloc_1[%arg2] : memref<160xf64>
            %9 = arith.addf %8, %7 : f64
            affine.store %9, %alloc_1[%arg2] : memref<160xf64>
          }
        }
        affine.for %arg2 = 0 to 160 {
          %0 = affine.load %alloc_1[%arg2] : memref<160xf64>
          affine.store %0, %alloc[%arg0, %arg1, %arg2] : memref<150x140x160xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
    scf.for %arg0 = %c0 to %c150 step %c1 {
      scf.for %arg1 = %c0 to %c140 step %c1 {
        scf.for %arg2 = %c0 to %c160 step %c1 {
          %0 = memref.load %alloc[%arg0, %arg1, %arg2] : memref<150x140x160xf64>
