module {
  func.func @main() -> i32 attributes { exported } {
    ...
    %alloc_6 = memref.alloc() : memref<40x80xf64>
    scf.for %arg0 = %c0 to %c40 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c80 step %c1 {
        ...
        %4 = arith.remsi %3, %c70_i32 : i32
        %5 = arith.sitofp %4 : i32 to f64
        %6 = arith.divf %5, %cst : f64
        memref.store %6, %alloc_6[%arg0, %arg1] : memref<40x80xf64>
      }
    }
    call @toggle_gpio() : () -> ()
    ...
    affine.for %arg0 = 0 to 40 {
      affine.for %arg1 = 0 to 80 {
        %0 = affine.load %alloc_6[%arg0, %arg1] : memref<40x80xf64>
        %1 = arith.mulf %0, %cst_5 : f64
        affine.store %1, %alloc_6[%arg0, %arg1] : memref<40x80xf64>
        %2 = arith.index_cast %arg1 : index to i32
        %3 = arith.addi %2, %c3_i32 : i32
        affine.for %arg2 = 0 to 50 {
          %4 = affine.load %alloc[%arg0, %arg2] : memref<40x50xf64>
          %5 = arith.index_cast %arg2 : index to i32
          %6 = arith.muli %5, %3 : i32
          %7 = arith.addi %6, %c1_i32 : i32
          %8 = arith.remsi %7, %c80_i32 : i32
          %9 = arith.sitofp %8 : i32 to f64
          %10 = arith.divf %9, %cst_0 : f64
          %11 = arith.mulf %4, %10 : f64
          %12 = affine.load %alloc_6[%arg0, %arg1] : memref<40x80xf64>
          %13 = arith.addf %12, %11 : f64
          affine.store %13, %alloc_6[%arg0, %arg1] : memref<40x80xf64>
        }
      }
    }
    call @toggle_gpio() : () -> ()
